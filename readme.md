...
এটা লার্জার প্রয়োগ এর জন্যে আপ্পলয়কবলে না ।

যদি আমাদের এর একটা কাউন্টার এর দরকার পরে । তাহলে আমাদের এর একটা কাউন্টার ক্রিয়েট করা লাগবে । তারপর id o class golo change করা লাগবে । তারপর js file এ id o class গলো ছাগয়ে করা লাগবে
